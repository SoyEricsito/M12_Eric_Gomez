document.addEventListener("DOMContentLoaded", () => {
    ...
    function crearTablero() {
        ...
        var elemento1 = document.querySelector('.celda.jugador1');
        var elemento2 = document.querySelector('.celda.jugador2');

        elemento1.style.backgroundColor = document.getElementById("colorJug1").value || "red";
        elemento2.style.backgroundColor = document.getElementById("colorJug2").value || "yellow";
    }
    ...
    volverAtrasBtn.addEventListener("click", () => {
        ...
        crearNumeros(); // Crear los numeros
